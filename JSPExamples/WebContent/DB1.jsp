...
<body>
<%
		int n=Integer.parseInt(request.getParameter("eno"));
		...
		if(rs.next())
		{
			...
			out.print("<input type='text' name='emgr' value='"+rs.getInt(4)+"'>");
			out.println("<br>Employee hiredate is:");
			out.print("<input type='text' name='ehd' value='"+rs.getDate(5)+"'>");
			...
			out.print("<input type='text' name='edept' value='"+rs.getInt(8)+"'>");
